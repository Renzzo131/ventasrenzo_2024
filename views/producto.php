								...
								<div class="row">
									<div class="col-12 text-center">
										<div class="txtwrap pr-md-10">
											<h1 class="fwEbold position-relative mb-0">NUEVOS ARTÍCULOS</h1>
											<strong class="year d-block fwEbold mb-3">2024</strong>
											<span class="sub-title d-block text-uppercase mb-md-12 mb-6">PRODUCTOS ÚNICOS</span>
											<a href="shop.html" class="btn btnTheme btnShop fwEbold text-white md-round py-3 px-4">Compra ahora<i class="fas fa-arrow-right ml-2"></i></a>
										</div>
									</div>
								</div>
					...
					<div class="col-12 col-sm-6 col-lg-3 mb-4 mb-lg-0">
						...
						<div class="contactListColumn border bg-lightGray overflow-hidden py-xl-5 py-md-3 py-2 px-xl-6 px-md-3 px-3 d-flex">
							...
							<div class="alignLeft pl-2">
								<strong class="headingV fwEbold d-block mb-1">Envío gratis</strong>
								<p class="m-0">En pedidos superiores a S/100</p>
							</div>
						</div>
					</div>
					<div class="col-12 col-sm-6 col-lg-3 mb-4 mb-lg-0">
						...
						<div class="contactListColumn border bg-lightGray overflow-hidden py-xl-5 py-md-3 py-2 px-xl-6 px-md-3 px-3 d-flex">
							...
							<div class="alignLeft pl-2">
								<strong class="headingV fwEbold d-block mb-1">Tarjeta de regalo</strong>
								<p class="m-0">La idea de regalo perfecta</p>
							</div>
						</div>
					</div>
					<div class="col-12 col-sm-6 col-lg-3 mb-4 mb-lg-0">
						...
						<div class="contactListColumn border bg-lightGray overflow-hidden py-xl-5 py-md-3 py-2 px-xl-4 px-md-2 px-3 d-flex">
							...
							<div class="alignLeft pl-2">
								<strong class="headingV fwEbold d-block mb-1">Devolución/Intercambio</strong>
								<p class="m-0">Devolución gratuita en 3 días</p>
							</div>
						</div>
					</div>
					<div class="col-12 col-sm-6 col-lg-3 mb-4 mb-lg-0">
						...
						<div class="contactListColumn border bg-lightGray overflow-hidden py-xl-5 py-md-3 py-2 px-xl-6 px-md-3 px-3 d-flex">
							...
							<div class="alignLeft pl-2">
								...
								<p class="m-0">Atención al cliente todo el tiempo</p>
							</div>
						</div>
					</div>
				</div>
